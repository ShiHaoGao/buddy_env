...
def make_atari_env(task, seed, training_num, test_num, **kwargs):
    """Wrapper function for Atari envs.

    If EnvPool is installed, it will automatically switch to EnvPool's Atari envs.

    :return: a tuple of (single envs, training envs, test envs).
    """
